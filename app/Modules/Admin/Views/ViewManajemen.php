    ...
    <nav class="navbar navbar-expand-lg navbar-dark" ; style="background-color: red;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                <a href="<?= base_url('arsenal/buatManajemen') ?>"><button type="button" class="btn btn-light mr-sm-2"><i class="fas fa-plus" style="color: red;"></i></button></a>
    ...
    <table class="table table-striped table-dark" ; style="width: 20cm;">
        <thead style="background-color: red;">
            <tr style='text-align:center; vertical-align:middle'>
                ...
                <th scope="col" style="width: 20%;">Negara</th>
                <th scope="col" style="width: 20%;">Foto</th>
                <th scope="col" style="width: 20%;">Editor</th>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr style='text-align:center; vertical-align:middle'>
                ...
                <td><img width="100px" src="<?= base_url(); ?>/uploads/<?= $row['foto']; ?>" alt=""></td>
                <td>
                    <a href="<?= base_url('arsenal/ubahManajemen') . '/' . $row['id_manajemen'] ?>"><button type="button" class="btn mr-sm-2" style="background-color: white; color: red"><i class="far fa-edit"></i></button></a>

                    <a href="<?= base_url('arsenal/hapusManajemen') . '/' . $row['id_manajemen'] ?>"><button type="button" class="btn btn-danger"><i class="far fa-trash-alt"></i></button></a>
                </td>
            </tr>
        <?php
                }
