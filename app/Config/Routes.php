...
$routes->get('/Arsenal', '\App\Modules\Admin\Controllers\Arsenal::index');
$routes->add('/Arsenal/(:any)', '\App\Modules\Admin\Controllers\Arsenal::$1');

$routes->get('/UserControl', '\App\Modules\User\Controllers\UserControl::index');
$routes->add('/UserControl/(:any)', '\App\Modules\User\Controllers\UserControl::$1');
