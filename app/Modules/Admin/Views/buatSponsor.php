...
<nav class="navbar navbar-expand-lg navbar-dark" ; style="background-color: red;">
    ...
    <form action="<?= base_url('Arsenal/simpanSponsor') ?>" method="POST" enctype="multipart/form-data" style="width: 20cm;">
        <div class="form-group">
            <label class="badge badge-light text-wrap" style="font-size: 15px; font-weight: bold; color: #8B0000;">ID</label>
            <input name="id_sponsor" class="form-control" type="text" placeholder="Masukkan ID">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input name="jenis" class="form-control" type="text" placeholder="Masukkan Posisi">
        </div>
