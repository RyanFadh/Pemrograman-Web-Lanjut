    ...
    <nav class="navbar navbar-expand-lg navbar-dark" ; style="background-color: red;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                <a href="<?= base_url('arsenal/buatSponsor') ?>"><button type="button" class="btn btn-light mr-sm-2"><i class="fas fa-plus" style="color: red;"></i></button></a>
    ...
    <table class="table table-striped table-dark" ; style="width: 20cm;">
        ...
        <tbody>
            ...
            <tr style='text-align:center; vertical-align:middle'>
                ...
                <td><?= $row['jenis']; ?></td>
                <td>
                    <a href="<?= base_url('arsenal/ubahSponsor') . '/' . $row['id_sponsor'] ?>"><button type="button" class="btn mr-sm-2" style="background-color: white; color: red"><i class="far fa-edit"></i></button></a>

                    <a href="<?= base_url('arsenal/hapusSponsor') . '/' . $row['id_sponsor'] ?>"><button type="button" class="btn btn-danger"><i class="far fa-trash-alt"></i></button></a>
                </td>
            </tr>
        <?php
                }
